...
export enum RUUTER_ENDPOINTS {
  ...
  GET_AVAILABLE_CSAS = 'available-customer-support-agents',
  GET_ORGANIZATION_WORKING_TIME = 'organization-working-time',
  SEND_CONTACT_INFO = '/chat/end-user/contact',
  AUTHENTICATE_USER = '/chat/end-user/name',
  GET_NEW_MESSAGES = '/new-messages',
  POST_MESSAGE = '/chat/message/add',
  POST_MESSAGE_PREVIEW = '/chat/message/preview',
  GET_MESSAGES_BY_CHAT_ID = '/messages',
  END_CHAT = '/chat/end',
  GET_GREETING = '/chat/greeting',
  GET_EMERGENCY_NOTICE = '/emergency-notice',
  SEND_NPM_RATING = '/cha/-feedback-rating',
  SEND_FEEDBACK_MESSAGE = '/chat/feedback-text',
  GET_WAITING_TIME = '/chat/estimated-waiting-time',
  SEND_MESSAGE_WITH_NEW_EVENT = '/chat/message/event',
  REMOVE_CHAT_FORWARDING_VALUE = '/chat/forward/remove',
  GENERATE_FORWARDING_REQUEST = '/chat/forward/add',
